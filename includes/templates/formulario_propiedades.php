<fieldset>
    ...
    <input type="file" id="imagen" name="propiedad[imagen]" value="<?php echo s($propiedad->imagen); ?>">
...
<fieldset>
    ...
    <input type="number" id="wc" name="propiedad[wc]" placeholder="Ejem: 2" min="1" value="<?php echo s($propiedad->wc); ?>">

    <label for="estacionamiento">Estacionamiento:</label>
    <input type="number" id="estacionamiento" name="propiedad[estacionamiento]" placeholder="Ejem: 2" min="1" value="<?php echo s($propiedad->estacionamiento); ?>">
